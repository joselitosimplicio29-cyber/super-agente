...
import { Zap, ArrowUp, Paperclip, X, FileText, Copy, Check, MoreHorizontal } from 'lucide-react'
  ...
  return (
    <div className="chat-root-light">
      <style>{`
        ...
        .btn-send:disabled { background: #E2E8F0; color: #94A3B8; }
      `}</style>
      ...
      <div className="chat-scroll">
        {loadingHistory ? (
          <div style={{ padding: 100, textAlign: 'center', color: '#94A3B8' }}>Carregando...</div>
        ) : (
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    {msg.content && (
                      <div className="actions-row">
                        <button className="action-btn" onClick={() => handleCopy(msg.content, i)}>
      ...
      <footer className="chat-footer">
        <div className="input-box-wrapper">
          <div className="input-box">
            <button className="icon-btn" style={{ color: '#94A3B8' }} onClick={() => fileRef.current?.click()}>
              <Paperclip size={20} />
            </button>
            <textarea
              ref={textareaRef}
            ...
            />
            <button className="icon-btn btn-send" onClick={enviar} disabled={loading || !input.trim()}>
              <ArrowUp size={20} />
            </button>
          </div>
        </div>
